 ...
 */
public class ProfessorControllerAPITest extends ApplicationTests {
    ...
    public void testCreateAndDeleteProfessor() throws Exception {
        ...
        MvcResult delete = mockMvc.perform(delete("/api/v1/professors/{id}", id)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
    ...
    public void testGetProfessorById() throws Exception {
        ...
        MvcResult getById = mockMvc.perform(get("/api/v1/professors/{id}", id)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
    ...
    @Test
    @WithMockUser(username="admin",roles={"ADMIN"})
    public void testUpdateProfessorById() throws Exception {
        Professor professor = new Professor(0, "Vineela", "Boddula", "boddulavineela@gmail.com", "111-222-3333", "Raleigh");
        MvcResult result = mockMvc.perform(post("/api/v1/professors")
                .content(objectMapper.writeValueAsString(professor))
                .contentType(MediaType.APPLICATION_JSON))
        ...
        Professor updateProfessor = new Professor(0, "Vineela1", "Boddula1", "boddulavineela1@gmail.com", "111-222-3333", "Raleigh");
        MvcResult update = mockMvc.perform(put("/api/v1/professors/{id}", id)
                .content(objectMapper.writeValueAsString(updateProfessor))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
    ...
    @Test
    @WithMockUser(username="admin",roles={"ADMIN"})
    public void testAssignProfessorToClass() throws Exception {
        //Create Class
        ...
        //Create Professor
        Professor professor = new Professor(0, "Vineela", "Boddula", "boddulavineela@gmail.com", "111-222-3333", "Raleigh");
        MvcResult result1 = mockMvc.perform(post("/api/v1/professors")
                .content(objectMapper.writeValueAsString(professor))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();

        assertEquals(200, result1.getResponse().getStatus());
        String professorId = JsonPath.read(result1.getResponse().getContentAsString(), "$.id").toString();

        MvcResult registerClass = mockMvc.perform(put("/api/v1/professors/{id}/assignClass", professorId)
                .content(objectMapper.writeValueAsString(aclass))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
        assertEquals(200, registerClass.getResponse().getStatus());
        //verify after registerClass
        MvcResult getById = mockMvc.perform(get("/api/v1/professors/{id}", professorId)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
        assertEquals(200, getById.getResponse().getStatus());
        assertEquals("Java", JsonPath.read(getById.getResponse().getContentAsString(), "$.classesTeaching").toString());

        //delete professor
        MvcResult delete = mockMvc.perform(delete("/api/v1/professors/{id}", professorId)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
        assertEquals(200, delete.getResponse().getStatus());
